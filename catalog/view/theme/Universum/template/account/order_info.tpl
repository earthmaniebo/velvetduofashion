...
<div id="content"><?php echo $content_top; ?>
  ...
  <form action="http://www.xend.com.ph/Tracker.aspx" target=_blank><div style="width:140px;height:155px;margin:0px auto;background-image:url(http://www.xend.com.ph/image/trackerwidget.png)"><div style=padding-top:60px><span style=padding-left:5px><input name=waybill style="width:130px;font-size:120%;color:DimGray"></span></div><div style="padding:8px 0 0 34px"><input type=submit value="" style="width:73px;height:25px;background:transparent;cursor:pointer;border:none"></div></div></form>
  <?php } ?>
  <div class="buttons">
