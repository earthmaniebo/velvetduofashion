  ...
  <?php } ?>
    ...
    <?php if ($thumb || $images) { ?>
      <div class="left">
        ...
        <?php $imagePreviewType = $this->config->get('UniversumControl_preview'); ?>
        <?php if(($this->config->get('UniversumControl_preview') != null) && ($this->config->get('UniversumControl_status') == '1')){ ?>
    	<?php include dirname(__FILE__) . '/' . $imagePreviewType; ?>
        <?php } else { ?>
